...
const works = [
  {
    title: 'Countries',
    worktype: { type: 'Front End Dev', year: '2023' },
    workImage: 'assets/Images/Countries React.PNG',
    workpara: 'This is a capstone project that uses React and Redux technologies. The website provides detailed information about countries by utilizing an API.    ',
    workcodes: ['Css', 'Html', 'Javascript', 'React', 'Redux'],
    workLive: 'https://maps-react.onrender.com/',
  ...
  },
  {
    ...
    worktype: { type: 'Front End Dev', year: '2023' },
    workImage: './assets/Images/Space-Travelers React.PNG',
    workpara: 'The "Space Travellers" will allow users to book rockets and join selected space missions.',
    workcodes: ['Css', 'Html', 'Javascript', 'React', 'Redux'],
    workLive: 'https://space-travelers-1204.onrender.com/',
    kSource: '<i class="fa-brands fa-github"></i>',
    Icons: '<i class="fa-solid fa-arrow-up-right-from-square"></i>',
    live: 'See Live',
    source: 'see-source',
